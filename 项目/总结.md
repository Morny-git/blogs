...
面试官你好，我是孟欣。15年毕业于太原理工大学计算机科学与技术专业。毕业后一直从事的是java后端开发技术。这期间经历了三段工作经验。第一家公司是一家创业型的小公司，在里面主要负责数据库建表与接口设计，虽然在待了4个月就倒闭了，但是也接触到了后台开发的思维思考方式。有了第一次的经验第二次选择了一个上市公司，在东方国信担任了一个小组长，工作主要负责需求的评审与表结构建立与接口的开发。在期间完成了各种的管理平台，感觉公司的培养方向是向管理方向发展，以及项目方向与自己有些不合适，寻找了第三家公司-360，在360主要负责的项目是dmp商品库，在期间接触到了大数据的开发以及高并发的服务。见证了商品数据从2亿增长到了数十亿。参与了重构商品解析、校验、审核流程、mysql切换kv以及es索引重构与扩容开发。现dmp商品库产品已趋于成熟，更新需求迭代也缓慢下来，想接触一些其他的项目来开拓眼界。趁着年轻没有负担  好好拼博一把。

項目介紹：
360商品库是**一站式的商品对接、存储、管理优化和输出应用****平台**，为广告主在展示、搜索流量投放广告时提供商品物料

360 商品库是用于接入、存储、管理结构化信息和输出投放的一站式平台。使用 广告主商品数据对动态个性化广告的投放提供数据支持，实现广告创意的千人千 面；同时用于搜索关键词，为广告主带来定向精准流量实现“万物”皆商品化。 主要分为以下几个模

360商品库主要根据广告主提供的数据进行一系列的规则转化、解析、校验、审核之后将商品数据存储在kv与es中。并将合格的商品信息发送给下游，为下游的动态个性化的投放以及定向精准投放提供数据支持。在平台上广告主可以根据广告主选择的多种条件实时预估商品数量以便更好的打包商品包进行投放商品。

平台实现了实时预估多条件的商品包的商品数以及小时级别的商品包商品计算。





根据选择多种关键字进行下游的pc 搜索也可以根据平台中选择的商品包或商品文件或者广告主id进行商品投放。
